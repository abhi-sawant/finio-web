      ...
      <Main className="lg:max-w-2xl">
        <div className="card-elevated space-y-6 rounded-md p-5">
          ...
          <Section title="1. Acceptance">
            By creating a cloud account, or by using Finio at all, you agree to these terms. If you
            don't agree, you can still use the app fully offline without an account — no terms apply
            to purely local use.
          </Section>
          ...
          <Section title="2. The service">
            ...
            required for the app to work. Finio does not connect to your bank, does not initiate or
            process payments, and does not provide investment or financial advice — it is a
          ...
          <Section title="3. Your account">
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>
                Everything entered under your account, and for setting a passphrase you can remember
                if you enable encrypted backups — it cannot be recovered if lost.
              </li>
          ...
          <Section title="5. Acceptable use">
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>
                Upload unlawful content into a backup, or use the account system for anything other
                than backing up your own finance data.
              </li>
            </ul>
          </Section>
          ...
          <Section title="6. Availability and no warranty">
            ...
            available," without warranties of any kind. We don't guarantee uninterrupted
            availability, and while backups are retained on a rolling basis, they are a convenience
            feature, not a guaranteed archival service — keep your own local export of anything you
          ...
          <Section title="8. Termination">
            You may stop using the service and delete your account at any time from Settings, which
            permanently removes your account and all associated backups. We may suspend or terminate
            accounts used in violation of section 5.
          </Section>

          <Section title="9. Self-hosted deployments">
            Finio's source is open, and these terms apply only to the officially hosted instance. If
            you connect the app to a self-hosted backend, your relationship — and these terms — are
            with whoever operates that server, not with us.
          </Section>
